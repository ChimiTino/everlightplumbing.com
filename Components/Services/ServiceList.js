...
export const ServiceList=[
    {
        ...
        img: '/iStock-1204813771.jpg',
        icon: <MdIcons.MdOutlinePlumbing className='ser-icon' />,
        description:''
    },
    {
        name:'Home Renovations & Restorations',
        img: '/male-architect-drawing-improvements-on-housing-plan-at-construction-site--891274328-5acbae1318ba0100375f4920.jpg',
